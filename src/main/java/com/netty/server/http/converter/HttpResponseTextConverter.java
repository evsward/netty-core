...
public class HttpResponseTextConverter extends HttpResponseConverter {
	
	private static final String HEADER_TEXT_CONTENT_TYPE = "text/plain; charset=%s";
	...
	public HttpResponse buildResponse(HttpServerContext serverContext,  HttpResponseMessage bizResponse) throws IOException{
		...
		response.setHeader(Constant.Http.HEADER_CONTENT_TYPE, String.format(HEADER_TEXT_CONTENT_TYPE, Constant.Http.DEFAULT_CHARSET));
